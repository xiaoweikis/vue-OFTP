...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      sample(){
        //拼接预报时间
        let dateYear = '样本周期：'+this.$store.state.firstCache.yearStart
          + '年-' + this.$store.state.firstCache.yearEnd + '年'+'&nbsp&nbsp&nbsp'+ 
          '预报时段:'+this.$store.state.firstCache.timeFrameStart +
